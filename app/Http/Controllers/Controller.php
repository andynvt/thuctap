...
class Controller extends BaseController
{
    ...
    public function displayIntro($viewintro) {
        $html = "";

        $html .= '<div class="carousel-item" style="display: block;">';
            $html .= '<img class="d-block w-100" src="storage/image/'.$viewintro[1]['pimage'].'" alt="First slide" style="height: 100vh">';
            $html .= '<div class="place-intro">';
                $html .= '<a href="#" style="color: white">';
                    $html .= '<h3>Địa điểm gần đây</h3>';
                    $html .= '<h1>'.$viewintro[1]['pname'].'</h1>';
                    $html .= '<div class="row">';
                        ...
                        $html .= '<div class="col-6 place-intro-right">';
                            $html .= '<h4>'.$viewintro[1]['address'].'</h4>';
                            $html .= '<h4>'.$viewintro[0]['distance'].' km</h4>';
                            $html .= '<h4>'.$viewintro[0]['time'].' phút (xe ô tô)</h4>';
                            $html .= '<h4>4.3 / 5 (20 đánh giá)</h4>';
                            $html .= '<h4>'.$viewintro[1]['ptname'].'</h4>';
                        $html .= '</div>';
                    $html .= '</div>';
                $html .= '</a>';
            $html .= '</div>';
                  ...
                  $html .= '<div class="card-body responsive-card-body">';
                    $html .= '<div class="tab-content text-center">';
                      $html .= '<div class="tab-pane active">';
                        $html .= '<p>'.$viewintro[1]['short_des'].'</p>';
                      $html .= '</div>';
