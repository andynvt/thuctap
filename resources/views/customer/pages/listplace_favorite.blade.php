            ...
            <div class="row" style=" padding-top:20px; margin-left: 0; margin-right: 15px;">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active col-12" id="viewList">
                                    ...
                                    <section class="list-place" id="favorite-place">
                                        <div class="title-dl ">
                                            <h3 class="text-primary" style="text-transform: uppercase">Địa điểm phổ biến nhất</h3>
                                        </div>
                                        <hr class="text-primary" style="border: 2px solid">

                                        @foreach($result_favorite as $rfav)
                                            <div class="item-place">
                                                <div class="row">
                                                    <div class="col-6 img-div" >
                                                        <a href="{{ route('detailplace',[$rfav ->pid]) }}"><img src="storage/image/{{$rfav -> piname}}" alt="{{$rfav -> pname}}"
                                                                                                                class="img-raised rounded img-fluid a-img"></a>
                                                    </div>
                                                    <div class="col-6 float-left">
                                                        <h3 style="margin-top: 0"><a href="{{ route('detailplace',[$rfav -> pid]) }}">{{$rfav -> pname}}<br></a>
                                                        </h3>
                                                        <div class="short-des">
                                                            {!! $rfav->short_des !!}
                                                        </div><br>
                                                        @component('customer.star_rating')
                                                            {{number_format((float)\App\Feedback::where('id_place',$rfav -> pid)->avg('star'),2,'.','')}}
                                                        @endcomponent
                                                        <p class="p-place">&nbsp;&nbsp;<b>{{number_format((float)\App\Feedback::where('id_place',$rfav -> pid)->avg('star'),2,'.','')}}/5</b>
                                                            trong <b>{{\App\Feedback::where('id_place',$rfav -> pid)->count('star')}}</b> ĐÁNH GIÁ
                                                        </p>

                                                        <div class="readMore float-right">
                                                            <a href="{{ route('detailplace',[$rfav ->pid]) }}" class="btn btn-primary btn-round btn-sm">
                                ...
                                <div class="tab-pane col-12" id="viewModule">
                                    ...
                                    <section class="list-place" id="favorite-place-1">
                                        ...
                                        <hr class="text-primary" style="border: 2px solid">
                                        <div class="row">
                                            @foreach($result_favorite as $rsfav)
                                                <div class="col-12 col-md-6 col-xl-6">
                                                    <div class="card">
                                                        <div class="card-header-image img-div">
                                                            <a href="{{ route('detailplace',[$rsfav ->pid]) }}"><img src="storage/image/{{$rsfav -> piname}}" alt="{{$rsfav -> pname}}"
                                                                                                                     class="img-raised rounded img-fluid a-img"></a>
                                                        </div>
                                                        <div class="card-body div-body">
                                                            <h5 class="card-title"><a href="{{ route('detailplace',[$rsfav ->pid]) }}">{{$rsfav -> pname}}<br></a></h5>
                                                            <div class="short-des">
                                                                {!! $rsfav -> short_des !!}
                                                                <br>
                                                            </div>
                                                            @component('customer.star_rating')
                                                                {{number_format((float)\App\Feedback::where('id_place',$rsfav -> pid)->avg('star'),2,'.','')}}
                                                            @endcomponent
                                                            <p class="p-place">&nbsp;&nbsp;<b>{{number_format((float)\App\Feedback::where('id_place',$rsfav -> pid)->avg('star'),2,'.','')}}/5</b> trong <b>{{\App\Feedback::where('id_place',$rsfav -> pid)->count('star')}}</b> ĐÁNH GIÁ</p>

                                                        </div>
                                                        <div class="card-footer div-footer">
                                                            <a href="{{ route('detailplace',[$rsfav ->pid]) }}" class="btn btn-primary btn-round btn-sm">
                                                                <i class="material-icons">details</i>Xem chi tiết<span class="badge badge-pill badge-primary"></span></a>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12 card col-card-top">
                    <div class="title-top card-header card-header-primary text-center">
                        <h3 style="text-transform: uppercase">TOP ĐỊA ĐIỂM HẤP DẪN</h3>
                    </div>
                    <br>
                    <div class="col-12 content-top text-center">
                        @foreach($result_top_fav as $rstop)
                            <div class="item-top ">
                                <div class="img-top">
