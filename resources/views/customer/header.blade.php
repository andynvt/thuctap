    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <div class="dropdown dropdown-city" data-spy="scroll" style="float:left;">
                       <a class="nav-link dropbtn"><i class="material-icons">apps</i>Thành phố</a>
                        <div class="dropdown-content scroll-city">
                            <div class="row col-12">
                                @foreach(App\City::all() as $c20)
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-4  city-name">
                                        <ul class="float-left scrollable-menu" style="padding-left: 5px; ">
                                            <li class="nav-item" style="font-size: 10px">
                                                <a id="name-city" href="{{route('customer.thanh-pho',[$c20->id,1])}}">
                                                    {{$c20->name}}
                                                </a>
                                            </li>
                                        </ul>
