        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title title">Sửa thông tin XXX</h4>
                </div>
                <div class="card-body">
                    <form action="">
                        <div class="row">
                            <div class="col-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="XXX" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" value="XXX" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" value="XXX" id="short_des" name="short_des"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="short_des">Mô tả đầy đủ</label>
                                    <textarea rows="5" class="form-control" placeholder="Khoảng 50 từ" value="XXX" id="full_des" name="full_des"></textarea>
                                </div>
